...
const userImage = require('./assets/icons8-user-64.png');
...
const data = [{
    ...
    description: 'Passionate about coding and creating awesome apps and looking for learning new skills set' + 'He loves using JS to build React Native applications ' + 'for iOS and Android', 
